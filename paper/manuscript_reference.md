...
- **Software release:** RDFR-CI v1.3.0
- **GitHub:** https://github.com/oltoHalmstad/RDFR-CI
- **v1.3.0 Zenodo DOI:** pending reservation
- **Previous v1.2.1 DOI:** 10.5281/zenodo.22662284

The manuscript and release are aligned at the specification/artifact level. Operational safety, practitioner reliability, labeled A1/A2 attack performance and comparative superiority remain outside the evidence established by this release.
